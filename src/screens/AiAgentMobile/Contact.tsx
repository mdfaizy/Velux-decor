              ...
              {[
                {
                  icon: "📍",
                  label: "Head Office",
                  val: "H 1-5-998/143/1 Road no 8, HT Rd, Citizen Colony, Ravindran Vajra Colony, Ambedkar Nagar, Alwal, Secunderabad, Telangana 500010, India.",
                },
                {
                  icon: "📞",
                  label: "Phone",
          ...
          <div className="bg-white rounded-[24px] p-12 shadow-[0_8px_48px_rgba(61,43,31,0.08)] border border-[rgba(201,168,76,0.1)]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <button
                ...
                disabled={loading}
                className={`bg-gradient-to-br from-[#C9A84C] to-[#8B6914] rounded-[10px] py-4 text-[14px] font-bold text-white uppercase tracking-[0.07em] shadow-[0_6px_20px_rgba(201,168,76,0.3)] transition ${loading ? "opacity-70 cursor-not-allowed" : "hover:-translate-y-[2px]"
                  }`}
              >
