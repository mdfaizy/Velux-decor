...
export const Quote = ({
  ...
  return (
    <div
      className={`flex flex-col w-[340px] items-start gap-4 p-6 relative bg-color-light-100 rounded-lg border border-solid border-color-light-250 ${className}`}
    >
      ...
      <div className="gap-3 self-stretch w-full flex-[0_0_auto] flex items-start relative">
        <img
          ...
          alt="Image"
          src="https://c.animaapp.com/mna8fbo8ynzy0E/img/image-8@2x.png"
        />
