...
export const FeaturesCard = ({
  ...
  imagePlaceholder = "https://c.animaapp.com/mna8fbo8ynzy0E/img/image-placeholder.svg",
}: Props): JSX.Element => {
  return (
    <div
      className={`flex flex-col w-80 items-start gap-[var(--spacing-spacing-xl)] pt-[var(--spacing-spacing-xl)] pr-[var(--spacing-spacing-xl)] pb-[var(--spacing-spacing-xl)] pl-[var(--spacing-spacing-xl)] relative bg-color-light-50 rounded-[var(--spacing-corner-radius-xl)] overflow-hidden border border-solid border-color-light-250 ${className}`}
    >
        ...
        {showIcon && (
          <div className="inline-flex items-center gap-2.5 p-4 relative flex-[0_0_auto] bg-color-primary-100 rounded-2xl border-[none] before:content-[''] before:absolute before:inset-0 before:p-px before:rounded-2xl before:[background:linear-gradient(180deg,rgba(255,135,71,1)_0%,rgba(23,23,23,0.1)_100%)] before:[-webkit-mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] before:[-webkit-mask-composite:xor] before:[mask-composite:exclude] before:z-[1] before:pointer-events-none">
            <InputIcons
              ...
              property1="zap"
              propertyZapSize="https://c.animaapp.com/mna8fbo8ynzy0E/img/input-icons-8.svg"
              size="big"
            />
          </div>
        )}
